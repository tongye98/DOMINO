#!/bin/bash
# Pipeline: Synthetic Code Generation via DOMINO contrastive soft tokens
# Customize paths for your environment.

LLM_MODEL="Qwen/Qwen2.5-Coder-7B-Instruct"
SOFT_PROMPT_DIR="./outputs/contrastive"
...
## Step 1: Generate synthetic instructions using learned public soft tokens
python -m domino.contrastive.generate \
    ...
    --device "cuda:0"
echo "======Synthetic Instruction Generation Done! $(date) ========"

## Step 2: Instruction quality assessment
python -m domino.pipeline.code_generation.quality_assessment \
    ...
    --devices "${DEVICES}"
echo "======Instruction Assessment Done! $(date) ========"

## Step 3: Generate code responses for high-quality instructions
python -m domino.pipeline.code_generation.generate_response \
