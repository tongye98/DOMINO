#!/bin/bash
# MAGPIE baseline: Code Generation (domain) using Qwen2.5-Coder-14B-Instruct
# Requires a cloned MAGPIE repo: https://github.com/magpie-align/magpie
# Usage: bash run_codegen_domain.sh [model_path] [total_prompts]

MAGPIE_DIR="../magpie"
MODEL_PATH=${1:-"Qwen/Qwen2.5-Coder-14B-Instruct"}
...
timestamp=${timestamp//-/}
job_name="code_gen_domain_${MODEL_PATH##*/}_topp${INS_TOP_P}_temp${INS_TEMP}_${timestamp}"
...
echo "[MAGPIE] Control Task: code_gen_domain"
